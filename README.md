...
|Derivative time, $Td$|60s|$0.25 \times Ti$|
|Proportional constant, $kp$|1.2|$0.60 \times Kc$|
|Integral constant, $ki$|0.0041667|$\sfrac{1}{Ti}$|
|Derivative constant, $kd$|6.0|$\sfrac{Td}{Ts}$|
